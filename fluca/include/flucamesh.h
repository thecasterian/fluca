...
typedef enum {
    MESHCARTESIAN_NULL_LOCATION = 0,
    MESHCARTESIAN_BACK,
    MESHCARTESIAN_DOWN,
    MESHCARTESIAN_LEFT,
    MESHCARTESIAN_ELEMENT,
    MESHCARTESIAN_RIGHT,
    MESHCARTESIAN_UP,
    MESHCARTESIAN_FRONT,
} MeshCartesianStencilLocation;
...
FLUCA_EXTERN PetscErrorCode MeshCartesianRestoreCoordinateArraysRead(Mesh, const PetscReal ***, const PetscReal ***,
                                                                     const PetscReal ***);
FLUCA_EXTERN PetscErrorCode MeshCartesianGetCoordinateLocationSlot(Mesh, MeshCartesianStencilLocation, PetscInt *);
FLUCA_EXTERN PetscErrorCode MeshCartesianGetGlobalSizes(Mesh, PetscInt *, PetscInt *, PetscInt *);
FLUCA_EXTERN PetscErrorCode MeshCartesianGetCorners(Mesh, PetscInt *, PetscInt *, PetscInt *, PetscInt *, PetscInt *,
                                                    PetscInt *);
FLUCA_EXTERN PetscErrorCode MeshCartesianGetIsFirstRank(Mesh, PetscBool *, PetscBool *, PetscBool *);
FLUCA_EXTERN PetscErrorCode MeshCartesianGetIsLastRank(Mesh, PetscBool *, PetscBool *, PetscBool *);
