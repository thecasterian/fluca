...
FLUCA_INTERN PetscErrorCode NSComputeFirstDerivBackwardDirichletCond_Cart(Direction dir, PetscInt i, PetscInt j, PetscInt k, PetscReal xW, PetscReal xP, PetscReal xe, PetscInt *ncols, DMStagStencil col[], PetscScalar v[]);
FLUCA_INTERN PetscErrorCode NSComputeFirstDerivBackwardNeumannCond_Cart(Direction dir, PetscInt i, PetscInt j, PetscInt k, PetscReal xW, PetscReal xP, PetscReal xe, PetscInt *ncols, DMStagStencil col[], PetscScalar v[]);
...
FLUCA_INTERN PetscErrorCode NSComputeFaceNormalDerivative_Cart(Direction dir, PetscInt i, PetscInt j, PetscInt k, PetscReal xW, PetscReal xP, PetscInt *ncols, DMStagStencil col[], PetscScalar v[]);
